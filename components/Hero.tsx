      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 py-6">
              <div className="text-center">
                ...
                <div className="text-lg sm:text-2xl font-bold text-gray-900">10,000+</div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a
                href="#demo-form"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-blue-600 text-white text-base sm:text-lg font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl"
              >
                Start Free Demo
              ...
              <a
                href="#courses"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-white text-blue-600 text-base sm:text-lg font-semibold rounded-lg border-2 border-blue-600 hover:bg-blue-50 transition-colors"
              >
                View Courses
              </a>
            </div>
          ...
          <div className="relative">
            <div className="relative h-64 sm:h-80 lg:h-[500px] w-full rounded-2xl overflow-hidden shadow-2xl">
              <Image
            ...
            <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-white p-4 sm:p-6 rounded-xl shadow-xl border border-gray-100">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="text-lg sm:text-2xl font-bold text-gray-900">AIR 1</div>
                  <div className="text-xs sm:text-sm text-gray-600">JEE Main 2024</div>
                </div>
              </div>
            </div>
          </div>
