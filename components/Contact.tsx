      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                {locations.map((location, index) => (
                  <div key={index} className="border-b border-gray-200 pb-6 last:border-b-0 last:pb-0">
                    <h4 className="text-lg font-semibold text-gray-900 mb-3">{location.name}</h4>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/919876543210" className="text-blue-200 hover:text-white">
                      +91 98765 43210
                    </a>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@excelacademy.com" className="text-blue-200 hover:text-white">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Visit Our Main Campus</h3>
